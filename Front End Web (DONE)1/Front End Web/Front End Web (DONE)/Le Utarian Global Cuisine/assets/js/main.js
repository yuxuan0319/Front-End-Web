...
function submitContactForm() {
  ...
  if (name === "") {
    console.log("The user didn't fill up the Name");
    alert("Please fill in your Name!");
  } else if (email === "") {
    console.log("The user didn't fill up the email");
    alert("Please fill in your Email!");
  } else if (subject === "") {
    console.log("The user didn't fill up the subject");
    alert("Please fill in the Subject!");
  } else if (message === "") {
    console.log("The user didn't fill up the message");
